...
def generate_launch_description():
    ...
    param_file_path=os.path.join(get_package_share_directory('my_navigation'),'config','nav2_params.yaml')
    ...
    #======调用原始launch文件，传入参数======
    my_packager_share_dir = get_package_share_directory('my_navigation')
